    ...
    public function output_html($data, $query='') {
        ...
        foreach ($subplugins as $name => $dir) {
            ...
            if (!$version) {
                ...
                $hideshow = html_writer::empty_tag('img', array('src'=>$OUTPUT->pix_url('t/hide'), 'class'=>'icon-small', 'alt'=>$strdisable));
                ...
                $hideshow = html_writer::empty_tag('img', array('src'=>$OUTPUT->pix_url('t/show'), 'class'=>'icon-small', 'alt'=>$strenable));
                $hideshow = html_writer::link($url, $hideshow);
                $displayname = $namestr;
                $class = 'dimmed_text';
            }
